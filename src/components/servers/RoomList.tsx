  ...
  if (loading && rooms.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-muted-foreground">SKANOWANIE POKOI...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold" data-testid="rooms-list-title">AKTYWNE POKOJE ({rooms.length})</h2>
        <Button 
          variant="outline" 
          size="sm" 
          onClick={onRefresh} 
      ...
      {rooms.length === 0 ? (
        <div className="text-center py-12" data-testid="rooms-empty-state">
          ...
          <h3 className="text-lg font-medium mb-2">BRAK AKTYWNYCH POKOI</h3>
